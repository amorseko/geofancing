...
class CarWorkingEcAfterPage extends StatefulWidget {

  String idUniq;


  @override
  State<StatefulWidget> createState() => _CarWorkingEcAfterPage();


  CarWorkingEcAfterPage({this.idUniq});
}

class _CarWorkingEcAfterPage extends State<CarWorkingEcAfterPage> {
