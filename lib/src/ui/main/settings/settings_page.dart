...
import 'package:geofancing/src/ui/main/settings/update_profile.dart';
    ...
    return Scaffold(
      ...
      body: ProgressDialog(
        ...
        child: Stack(
          ...
          children: <Widget>[
            Padding(
              padding: new EdgeInsets.only(top: 10.0, left: 20, right: 10),
              child: Column(
                children: <Widget>[
                  _bgHeader(context),
                  Container(
                  ...
                  ListView(
                    ...
                    children: <Widget>[
                      ...
                      ListTile(
                          title: Text(allTranslations.text("txt_changeprofile"),
                              style: TextStyle(
                                  fontSize: 15, fontWeight: FontWeight.bold)),
                          leading: new Image.asset(
